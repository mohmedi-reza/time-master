    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-base-300 to-base-200 px-4 animate-fadeIn">
      <div className="card w-full max-w-md bg-base-100 shadow-2xl transition-all duration-300 hover:shadow-primary/10">
        <div className="card-body p-8">
          ...
          <h2 className="card-title justify-center text-2xl mb-3 text-center">{t('signIn')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" id="login-form" name="login-form">
            <div className="form-control">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/50">
                  <Icon name="user" className=" text-base-content text-lg" />
                </span>
                <input
                  type="email"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/50">
                  <Icon name="lock" className="text-base-content text-lg" />
                </span>
                <input
                  type="password"
                  placeholder="••••••••"
          ...
          <div className="divider my-3">{t('or')}</div>
          
          <div className=" gap-3 flex justify-center">
            <button className="btn btn-outline btn-circle gap-2">
          ...
          <div className="text-center mt-8">
            <p>{t('dontHaveAccount')} <a href="/auth/register" className="link link-primary font-medium">{t('signUp')}</a></p>
          </div>
        </div>
      </div>
